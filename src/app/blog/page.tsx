...
export const metadata: Metadata = {
  title: 'Blog | Insights, Guides & Career Tips',
  description: 'Read our latest articles on coding, digital marketing, and the top skills students need to thrive in 2026.',
};
